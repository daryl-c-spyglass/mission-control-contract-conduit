  ...
  return (
    ...
    >
      ...
      <div className="absolute left-[70px] top-[42px] right-6 h-[50px] flex items-center">
        ...
        {/* Price Badge */}
        <div className="absolute right-[25px] top-[-4px] w-[144px] h-[58px] bg-[#867d71] flex flex-col justify-center items-center text-white">
      ...
      >
        ...
        >
          <div className="flex items-center gap-2 text-[11pt] whitespace-nowrap" style={{ marginBottom: '33px', color: '#4a4a4a' }}>
            <svg className="w-[24px] h-[24px] flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="#4a4a4a" strokeWidth="1.5">
          ...
          <div className="flex items-center gap-2 text-[11pt] whitespace-nowrap" style={{ color: '#4a4a4a' }}>
            <svg className="w-[24px] h-[24px] flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="#4a4a4a" strokeWidth="1.5">
          ...
          <div
            ...
            style={{ width: '2px', height: '160px', backgroundColor: accentColor, right: '7px' }}
        ...
        >
          <div 
            ...
            style={{ width: '113px', height: '113px', right: '-79px' }}
          >
            {images.agentPhoto ? (
              <img
