...
function CoverSlideContent({ address, agent }: { address: string; agent: AgentProfile }) {
  return (
    <div className="flex flex-col items-center justify-center h-full text-center">
      ...
      />
      <h1 className="text-2xl font-bold text-zinc-900 mb-6">COMPARATIVE MARKET ANALYSIS</h1>
      <p className="text-lg text-zinc-700 mb-8">{address}</p>
      <div className="mt-4">
        <p className="text-sm text-zinc-500">Prepared by</p>
        <p className="text-base font-semibold text-zinc-900">{agent?.name || 'Agent'}</p>
