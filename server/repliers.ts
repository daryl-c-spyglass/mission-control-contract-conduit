...
export async function fetchMLSListing(mlsNumber: string, boardId?: string): Promise<{ mlsData: MLSListingData } | null> {
  try {
...
// Fetch listing details for a single MLS listing
